...
# g.invite_user("rmiller+test1@getguru.com")
...
# g.add_user_to_groups("rmiller+test1@getguru.com", "group name", "other group")
# g.add_user_to_groups("rmiller+test2@getguru.com", "other group", "New Group")
